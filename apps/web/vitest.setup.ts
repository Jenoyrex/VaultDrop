...
// Same story for `File`: it's a named export of node:buffer since Node
// 18.13.0 but wasn't promoted to a global until Node 20. Guarded so this
// is a no-op wherever File is already global (Node 20+, browsers, jsdom).
